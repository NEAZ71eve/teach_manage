...
public class ExamPaperQuestionRepository {
    ...
    public List<ExamPaperQuestion> findByPaperId(String paperId) {
        String sql = "SELECT * FROM exam_paper_question WHERE paper_id = ?";
    ...
    public List<ExamPaperQuestion> findByQuestionId(Integer questionId) {
        String sql = "SELECT * FROM exam_paper_question WHERE question_id = ?";
    ...
    public int save(ExamPaperQuestion examPaperQuestion) {
        String sql = "INSERT INTO exam_paper_question (paper_id, question_id, question_order, score) VALUES (?, ?, ?, ?)";
    ...
    public int update(ExamPaperQuestion examPaperQuestion) {
        String sql = "UPDATE exam_paper_question SET question_id = ?, question_order = ?, score = ? WHERE id = ?";
        return jdbcTemplate.update(sql, 
                examPaperQuestion.getQuestionId(), 
                examPaperQuestion.getQuestionOrder(), 
                examPaperQuestion.getScore(), 
    ...
    public int deleteById(Integer id) {
        String sql = "DELETE FROM exam_paper_question WHERE id = ?";
