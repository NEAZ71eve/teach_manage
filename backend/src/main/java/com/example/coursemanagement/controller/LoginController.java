...
public class LoginController {
    ...
    private List<Permission> buildProgramTeacherPermissions() {
        return Arrays.asList(
                ...
                buildPermission(501, "查看实践项目列表", "practice-project:list"),
                buildPermission(502, "新增实践项目", "practice-project:add"),
                buildPermission(503, "编辑实践项目", "practice-project:edit"),
                buildPermission(504, "删除实践项目", "practice-project:delete"),
